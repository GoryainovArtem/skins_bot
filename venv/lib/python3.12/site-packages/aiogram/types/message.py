...
class Message(MaybeInaccessibleMessage):
    ...
    """*Optional*. For text messages, special entities like usernames, URLs, bot common, etc. that appear in the text"""
    ...
    """*Optional*. For messages with a caption, special entities like usernames, URLs, bot common, etc. that appear in the caption"""
