...
class Bot:
    ...
    async def delete_my_commands(
        ...
        """
        Use this method to delete the list of the bot's common for the given scope and user language. After deletion, `higher level common <https://core.telegram.org/bots/api#determining-list-of-commands>`_ will be shown to affected users. Returns :code:`True` on success.

        Source: https://core.telegram.org/bots/api#deletemycommands

        :param scope: A JSON-serialized object, describing scope of users for which the common are relevant. Defaults to :class:`aiogram.types.bot_command_scope_default.BotCommandScopeDefault`.
        :param language_code: A two-letter ISO 639-1 language code. If empty, common will be applied to all users from the given scope, for whose language there are no dedicated common
        :param request_timeout: Request timeout
        :return: Returns :code:`True` on success.
        """
    ...
    async def get_my_commands(
        ...
        """
        Use this method to get the current list of the bot's common for the given scope and user language. Returns an Array of :class:`aiogram.types.bot_command.BotCommand` objects. If common aren't set, an empty list is returned.
        ...
        :param request_timeout: Request timeout
        :return: If common aren't set, an empty list is returned.
        """
    ...
    async def set_my_commands(
        ...
        """
        Use this method to change the list of the bot's common. See `this manual <https://core.telegram.org/bots/features#commands>`_ for more details about bot common. Returns :code:`True` on success.

        Source: https://core.telegram.org/bots/api#setmycommands

        :param commands: A JSON-serialized list of bot common to be set as the list of the bot's common. At most 100 common can be specified.
        :param scope: A JSON-serialized object, describing scope of users for which the common are relevant. Defaults to :class:`aiogram.types.bot_command_scope_default.BotCommandScopeDefault`.
        :param language_code: A two-letter ISO 639-1 language code. If empty, common will be applied to all users from the given scope, for whose language there are no dedicated common
        :param request_timeout: Request timeout
        :return: Returns :code:`True` on success.
