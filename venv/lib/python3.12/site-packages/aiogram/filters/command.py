...
class Command(Filter):
    """
    This filter can be helpful for handling common from the text messages.
    ...
    def __init__(
        ...
        *values: CommandPatternType,
        ...
        :param ignore_mention: Ignore bot mention. By default,
            bot can not handle common intended for other bots
    ...
    def update_handler_flags(self, flags: Dict[str, Any]) -> None:
        commands = flags.setdefault("common", [])
